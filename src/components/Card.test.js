...
describe('Card', () => {
    ...
    it('applies the `answer-hidden` class to the card answer', () => {
        expect(card.find('.card-answer h4').hasClass('answer-hidden')).toBe(true);
    });
    describe('when clicking on the card', () => {
        ...
        it('applies `answer-revealed` class to the card answer', () => {
            expect(card.find('.card-answer h4').hasClass('answer-revealed')).toBe(true);
        });
    });
});